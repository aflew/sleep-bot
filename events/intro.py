...
async def main(ctx):
    ...
    await ctx.author.send('We do this in 3 simple ways. \
    ...
    await ctx.author.send('You initiated Sleep Bot by inputting "!start". If you would like to remove Sleep Bot and its data, input "!cancel". \
    ...
    await ctx.author.send('Use this format: !set mon 06:30')
    ...
    await ctx.author.send('To resend the introduction, input "!intro".')
